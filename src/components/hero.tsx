...
import teamPic2 from "../assets/images/team2.png";

export default function Hero() {
  return (
    <main className="bg-[url(../assets/images/team2.png)]">
      <div className="bg-primary bg-opacity-90">
        ...
        <div className="relative isolate pt-5 ">
          <div className="absolute inset-y-0 right-1/2 -z-10 -mr-96 w-[200%] origin-top-right skew-x-[-30deg] bg-secondary bg-opacity-75 sm:-mr-80 lg:-mr-96" />
            ...
            <div className="mx-auto max-w-2xl lg:mx-0 lg:grid lg:max-w-none lg:grid-cols-2 lg:gap-x-16 lg:gap-y-6 xl:grid-cols-1 xl:grid-rows-1 xl:gap-x-8">
              ...
              <div className="mt-6 max-w-xl lg:mt-0 xl:col-end-1 xl:row-start-1">
                <p className="text-lg leading-8 text-gray-800">
                  Au Camel Studio on sait comment garder la tête froide même
                  dans les projets les plus chauds. Pas de bosses, que des
                  solutions.
                </p>
